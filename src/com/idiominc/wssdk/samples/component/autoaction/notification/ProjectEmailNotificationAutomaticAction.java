 ...
 */
public class ProjectEmailNotificationAutomaticAction
    ...
    private static final Logger log =
        Logger.getLogger( ProjectEmailNotificationAutomaticAction.class );
     ...
     */
    private static final String EMAIL_BODY_PARAM_DEFAULT =
        "The WorldServer project '${project.name}' that was submitted " +
        "by ${project.creator.username} on ${project.creationdate} is now " + 
        "complete.";
    ...
    public WSActionResult execute (WSContext context,
         ...
         */
        String emailText =
            (String) parameters.get(EMAIL_BODY_PARAM_NAME);
        if ( emailText == null ) {
            emailText = EMAIL_BODY_PARAM_DEFAULT;
        }
        ...
        emailText = replacer.replaceParameters( emailText );
